...
#     f_name    = '1.fil'
     ...
     nbin      = 0
     angle     = [0,0] #Angle range for search
...
######################
     ...
     fil, num, p_n, freq, t_rsl, t_len, nbin ,nch, T,fy,angle,N_Ang,L_fft = read_data(f_dir, f_name ,t_len, nbin, comm_size,DM_range,Wp,angle)
...
#	     data[:220,:]=0
	     ...
	     if comm_rank == 0:
			 ...
			 print 'Angle range:',angle
                         print 'SNR:',SNR,';DM: ',DM
                         print '###############\n\nBegin to plot...'
	     plot(comm_rank,t_axis,data,re_data,polar_data,FFT1st_data,FFT2nd_data,plot_proc,freq,f_axis,rad_rsl,ang_rsl,plot_dir,pixel,angle,i_ch,p_n,SNR,DM,A_f)
