...
#     f_name    = 'fake_test.fil'
     ...
     plot_proc = '2ndFFT_3D,polar_sets_3D,,1stFFT,2ndFFT_2D'
...
###################
     ...
     for  i_ch in range(p_n):  #i_chunk 
	     ...
	     FFT1st_data = FFT(data, 2, msk_cycle=0)
	     ...
	     if SNR > 0:	
		     plot(comm_rank,t_axis,0,0,polar_data,FFT1st_data,FFT2nd_data,plot_proc,freq,f_axis,2,rad_rsl,ang_rsl,plot_dir,pixel,ang_min,ang_max,i_ch,p_n)
